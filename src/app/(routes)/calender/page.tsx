  ...
  return (
    <div className="flex items-center justify-center h-full bg-gray-100">
      <div className="flex flex-col md:flex-row w-full max-w-6xl p-4">
        <div className="flex flex-col flex-1 p-6 rounded-lg space-y-4 md:w-1/2">
          <div className="w-full shadow-lg rounded-lg bg-white space-y-3 m-4">
              ...
              {generateDays().map((day, index) => (
                <div
                  ...
                  className={`w-12 h-12 flex items-center justify-center rounded-lg cursor-pointer transition-all hover:bg-gray-300 
                    ${day !== null && availableDays.includes(day) ? "bg-green-400 text-white font-bold" : "text-gray-600"}
            ...
            <div className="flex justify-around items-center text-xs p-2 bg-white">
        ...
        <div className="flex flex-col md:flex-1 border border-gray-600 p-6 rounded-lg shadow-lg m-5 bg-white h-full md:h-auto">
          <Summary />
        </div>
      </div>
    </div>
